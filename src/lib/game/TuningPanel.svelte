...
<script lang="ts">
	...
	const TUNING_RANGE: Record<string, { min: number; max: number; step: number }> = {
		...
		'UNDERWATER.ridgeGain': { min: 0, max: 2.5, step: 0.02 },
		...
		'UNDERWATER.diffuseDepthM': { min: 2, max: 200, step: 1 },
		'UNDERWATER.causticFloor': { min: 0, max: 1, step: 0.01 },
		'UNDERWATER.causticFocusM': { min: 0.02, max: 6, step: 0.02 },
		'UNDERWATER.causticSourceBlurM': { min: 0, max: 0.6, step: 0.005 },
		'UNDERWATER.causticContrast': { min: 0.2, max: 4, step: 0.05 },
		'UNDERWATER.causticFocalM': { min: 0, max: 6, step: 0.1 },
		'UNDERWATER.causticBlurPerM': { min: 0, max: 1.5, step: 0.01 },
		...
		'UNDERWATER.flatStart': { min: 0, max: 1, step: 0.01 },
		'UNDERWATER.flatEnd': { min: 0, max: 1, step: 0.01 },
